...
export type AccountCreateaccountBodyParam = FromSchema<
  typeof schemas.AccountCreateaccount.body
>;
...
>;
export type AccountGetaccountBodyParam = FromSchema<
  typeof schemas.AccountGetaccount.body
>;
...
>;
export type BroadcasthexBodyParam = FromSchema<
  typeof schemas.Broadcasthex.body
>;
export type BroadcasthexResponse200 = FromSchema<
  (typeof schemas.Broadcasthex.response)["200"]
>;
export type BroadcasthexResponse400 = FromSchema<
  (typeof schemas.Broadcasthex.response)["400"]
>;
export type BroadcasttransactionBodyParam = FromSchema<
  typeof schemas.Broadcasttransaction.body
>;
export type BroadcasttransactionResponse200 = FromSchema<
  (typeof schemas.Broadcasttransaction.response)["200"]
>;
export type Cancelallunfreezev2BodyParam = FromSchema<
  typeof schemas.Cancelallunfreezev2.body
>;
...
export type ClearabiResponse200 = FromSchema<
  (typeof schemas.Clearabi.response)["200"]
>;
export type ClearabiResponse400 = FromSchema<
  (typeof schemas.Clearabi.response)["400"]
>;
export type CreateaddressBodyParam = FromSchema<
  typeof schemas.Createaddress.body
>;
export type CreateaddressResponse200 = FromSchema<
  (typeof schemas.Createaddress.response)["200"]
>;
export type CreateaddressResponse400 = FromSchema<
  (typeof schemas.Createaddress.response)["400"]
>;
export type CreateassetissueBodyParam = FromSchema<
  typeof schemas.Createassetissue.body
>;
...
>;
export type CreatespendauthsigBodyParam = FromSchema<
  typeof schemas.Createspendauthsig.body
>;
...
>;
export type CreatetransactionBodyParam = FromSchema<
  typeof schemas.Createtransaction.body
>;
...
>;
export type CreatewitnessBodyParam = FromSchema<
  typeof schemas.Createwitness.body
>;
export type CreatewitnessResponse200 = FromSchema<
  (typeof schemas.Createwitness.response)["200"]
>;
export type CreatewitnessResponse400 = FromSchema<
  (typeof schemas.Createwitness.response)["400"]
>;
export type Delegateresource1BodyParam = FromSchema<
  typeof schemas.Delegateresource1.body
>;
...
>;
export type EasytransferBodyParam = FromSchema<
  typeof schemas.Easytransfer.body
>;
export type EasytransferResponse200 = FromSchema<
  (typeof schemas.Easytransfer.response)["200"]
>;
export type EasytransferResponse400 = FromSchema<
  (typeof schemas.Easytransfer.response)["400"]
>;
export type EasytransferassetBodyParam = FromSchema<
  typeof schemas.Easytransferasset.body
>;
...
>;
export type EasytransferbyprivateBodyParam = FromSchema<
  typeof schemas.Easytransferbyprivate.body
>;
...
>;
export type EstimateenergyBodyParam = FromSchema<
  typeof schemas.Estimateenergy.body
>;
export type EstimateenergyResponse200 = FromSchema<
  (typeof schemas.Estimateenergy.response)["200"]
>;
export type EstimateenergyResponse400 = FromSchema<
  (typeof schemas.Estimateenergy.response)["400"]
>;
export type ExchangecreateBodyParam = FromSchema<
  typeof schemas.Exchangecreate.body
>;
export type ExchangecreateResponse200 = FromSchema<
  (typeof schemas.Exchangecreate.response)["200"]
>;
export type ExchangecreateResponse400 = FromSchema<
  (typeof schemas.Exchangecreate.response)["400"]
>;
export type ExchangeinjectBodyParam = FromSchema<
  typeof schemas.Exchangeinject.body
>;
export type ExchangeinjectResponse200 = FromSchema<
  (typeof schemas.Exchangeinject.response)["200"]
>;
export type ExchangeinjectResponse400 = FromSchema<
  (typeof schemas.Exchangeinject.response)["400"]
>;
export type ExchangetransactionBodyParam = FromSchema<
  typeof schemas.Exchangetransaction.body
>;
...
>;
export type ExchangewithdrawBodyParam = FromSchema<
  typeof schemas.Exchangewithdraw.body
>;
...
>;
export type Freezebalancev21BodyParam = FromSchema<
  typeof schemas.Freezebalancev21.body
>;
...
>;
export type GetaccountbalanceBodyParam = FromSchema<
  typeof schemas.Getaccountbalance.body
>;
...
>;
export type GetaccountnetBodyParam = FromSchema<
  typeof schemas.Getaccountnet.body
>;
export type GetaccountnetResponse200 = FromSchema<
  (typeof schemas.Getaccountnet.response)["200"]
>;
export type GetaccountresourceBodyParam = FromSchema<
  typeof schemas.Getaccountresource.body
>;
...
>;
export type GetakfromaskBodyParam = FromSchema<
  typeof schemas.Getakfromask.body
>;
export type GetakfromaskResponse200 = FromSchema<
  (typeof schemas.Getakfromask.response)["200"]
>;
export type GetakfromaskResponse400 = FromSchema<
  (typeof schemas.Getakfromask.response)["400"]
>;
export type GetassetissuebyaccountBodyParam = FromSchema<
  typeof schemas.Getassetissuebyaccount.body
>;
export type GetassetissuebyidBodyParam = FromSchema<
  typeof schemas.Getassetissuebyid.body
>;
...
export type Getblock1Response200 = FromSchema<
  (typeof schemas.Getblock1.response)["200"]
>;
export type GetblockbalanceBodyParam = FromSchema<
  typeof schemas.Getblockbalance.body
>;
...
>;
export type GetblockbyidBodyParam = FromSchema<
  typeof schemas.Getblockbyid.body
>;
export type GetblockbyidResponse200 = FromSchema<
  (typeof schemas.Getblockbyid.response)["200"]
>;
export type GetblockbylimitnextBodyParam = FromSchema<
  typeof schemas.Getblockbylimitnext.body
>;
...
>;
export type GetburntrxResponse200 = FromSchema<
  (typeof schemas.Getburntrx.response)["200"]
>;
...
>;
export type GetcontractinfoBodyParam = FromSchema<
  typeof schemas.Getcontractinfo.body
>;
...
>;
export type GetdelegatedresourceBodyParam = FromSchema<
  typeof schemas.Getdelegatedresource.body
>;
...
>;
export type GetdiversifierResponse200 = FromSchema<
  (typeof schemas.Getdiversifier.response)["200"]
>;
export type GetdiversifierResponse400 = FromSchema<
  (typeof schemas.Getdiversifier.response)["400"]
>;
...
>;
export type GetincomingviewingkeyBodyParam = FromSchema<
  typeof schemas.Getincomingviewingkey.body
>;
...
>;
export type GetnkfromnskBodyParam = FromSchema<
  typeof schemas.Getnkfromnsk.body
>;
export type GetnkfromnskResponse200 = FromSchema<
  (typeof schemas.Getnkfromnsk.response)["200"]
>;
export type GetnkfromnskResponse400 = FromSchema<
  (typeof schemas.Getnkfromnsk.response)["400"]
>;
export type GetpaginatedassetissuelistBodyParam = FromSchema<
  typeof schemas.Getpaginatedassetissuelist.body
>;
export type GetpendingsizeResponse200 = FromSchema<
  (typeof schemas.Getpendingsize.response)["200"]
>;
export type GetpendingsizeResponse400 = FromSchema<
  (typeof schemas.Getpendingsize.response)["400"]
>;
export type GetproposalbyidBodyParam = FromSchema<
  typeof schemas.Getproposalbyid.body
>;
...
>;
export type GetspendingkeyResponse200 = FromSchema<
  (typeof schemas.Getspendingkey.response)["200"]
>;
export type GetspendingkeyResponse400 = FromSchema<
  (typeof schemas.Getspendingkey.response)["400"]
>;
...
>;
export type GettransactionsignBodyParam = FromSchema<
  typeof schemas.Gettransactionsign.body
>;
...
>;
export type GetzenpaymentaddressBodyParam = FromSchema<
  typeof schemas.Getzenpaymentaddress.body
>;
...
>;
export type HttpGetapprovedlistBodyParam = FromSchema<
  typeof schemas.HttpGetapprovedlist.body
>;
...
>;
export type ParticipateassetissueBodyParam = FromSchema<
  typeof schemas.Participateassetissue.body
>;
...
>;
export type ProposalapproveBodyParam = FromSchema<
  typeof schemas.Proposalapprove.body
>;
...
>;
export type ProposalcreateBodyParam = FromSchema<
  typeof schemas.Proposalcreate.body
>;
export type ProposalcreateResponse200 = FromSchema<
  (typeof schemas.Proposalcreate.response)["200"]
>;
export type ProposalcreateResponse400 = FromSchema<
  (typeof schemas.Proposalcreate.response)["400"]
>;
export type ProposaldeleteBodyParam = FromSchema<
  typeof schemas.Proposaldelete.body
>;
export type ProposaldeleteResponse200 = FromSchema<
  (typeof schemas.Proposaldelete.response)["200"]
>;
export type ProposaldeleteResponse400 = FromSchema<
  (typeof schemas.Proposaldelete.response)["400"]
>;
...
>;
export type TransferassetBodyParam = FromSchema<
  typeof schemas.Transferasset.body
>;
export type TransferassetResponse200 = FromSchema<
  (typeof schemas.Transferasset.response)["200"]
>;
export type TransferassetResponse400 = FromSchema<
  (typeof schemas.Transferasset.response)["400"]
>;
...
>;
export type TriggersmartcontractBodyParam = FromSchema<
  typeof schemas.Triggersmartcontract.body
>;
...
>;
export type Undelegateresource1BodyParam = FromSchema<
  typeof schemas.Undelegateresource1.body
>;
...
>;
export type UnfreezeassetBodyParam = FromSchema<
  typeof schemas.Unfreezeasset.body
>;
export type UnfreezeassetResponse200 = FromSchema<
  (typeof schemas.Unfreezeasset.response)["200"]
>;
export type UnfreezeassetResponse400 = FromSchema<
  (typeof schemas.Unfreezeasset.response)["400"]
>;
export type Unfreezebalancev21BodyParam = FromSchema<
  typeof schemas.Unfreezebalancev21.body
>;
...
>;
export type UpdateaccountBodyParam = FromSchema<
  typeof schemas.Updateaccount.body
>;
export type UpdateaccountResponse200 = FromSchema<
  (typeof schemas.Updateaccount.response)["200"]
>;
export type UpdateaccountResponse400 = FromSchema<
  (typeof schemas.Updateaccount.response)["400"]
>;
export type UpdatewitnessBodyParam = FromSchema<
  typeof schemas.Updatewitness.body
>;
export type UpdatewitnessResponse200 = FromSchema<
  (typeof schemas.Updatewitness.response)["200"]
>;
export type ValidateaddressBodyParam = FromSchema<
  typeof schemas.Validateaddress.body
>;
...
>;
export type VotewitnessaccountBodyParam = FromSchema<
  typeof schemas.Votewitnessaccount.body
>;
...
>;
export type WalletDeploycontractBodyParam = FromSchema<
  typeof schemas.WalletDeploycontract.body
>;
...
>;
export type WalletGetblockbynumBodyParam = FromSchema<
  typeof schemas.WalletGetblockbynum.body
>;
export type WalletGetblockbynumResponse200 = FromSchema<
  (typeof schemas.WalletGetblockbynum.response)["200"]
>;
export type WalletGetbrokerageBodyParam = FromSchema<
  typeof schemas.WalletGetbrokerage.body
>;
...
>;
export type WalletGetcontractBodyParam = FromSchema<
  typeof schemas.WalletGetcontract.body
>;
...
>;
export type WalletGetexchangebyidBodyParam = FromSchema<
  typeof schemas.WalletGetexchangebyid.body
>;
...
>;
export type WalletGetrewardBodyParam = FromSchema<
  typeof schemas.WalletGetreward.body
>;
...
>;
export type WalletUpdateassetBodyParam = FromSchema<
  typeof schemas.WalletUpdateasset.body
>;
...
>;
export type WalletUpdatebrokerageBodyParam = FromSchema<
  typeof schemas.WalletUpdatebrokerage.body
>;
...
>;
export type WalletUpdatesettingBodyParam = FromSchema<
  typeof schemas.WalletUpdatesetting.body
>;
...
>;
export type WithdrawbalanceBodyParam = FromSchema<
  typeof schemas.Withdrawbalance.body
>;
